...
"
spice_ignore=false}
C {dickson.sym} 60 -230 0 0 {name=x1}
...
C {devices/vdd.sym} -140 -260 0 0 {name=l1 lab=3V3}
...
C {devices/lab_pin.sym} 210 -260 2 0 {name=p3 sig_type=std_logic lab=ua[0]}
...
C {devices/vsource.sym} 370 -210 0 0 {name=V3 value=3.3}
C {devices/gnd.sym} 370 -180 0 0 {name=l2 lab=GND}
C {devices/vdd.sym} 370 -240 0 0 {name=l7 lab=3V3}
C {devices/vdd.sym} -110 -260 0 0 {name=l8 lab=VDD}
